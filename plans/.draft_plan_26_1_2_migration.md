# Draft Plan: 26.1.2 Migration — Kenergy Engineering Retechnicalized

## 元数据

- **计划 ID**: `26_1_2_migration`
- **版本**: 0.3 (草稿)
- **创建日期**: 2026-07-08
- **创建者**: 猫娘规划师-缇娅
- **状态**: `草稿`
- **workflow_mode**: standard
- **草案路径**: `plans/.draft_plan_26_1_2_migration.md`
- **触发原因**: 初版计划审查未通过，按审查意见修订 — 主要问题：任务粒度不足（Phase 级编号列表非独立 TASK）、模糊动作词缺乏具体命令/判断条件、Phase 0 缺统一外部证据采集任务、依赖清单证据列不足、Phase 4 DoD 未引用内容完整性 Checklist、Phase 6 缺收口验证引用
- **建议下一步**: 复审 — P1-P6 已修复（由猫娘审查官-艾琳执行）
...
|------|---------|---------|---------|---------|---------|------|---------|
| NeoForge | 26.1.2 | 26.1.2 | `libs.versions.toml` | ✅ 已在配置 | `.\gradlew.bat dependencies \| grep neoforge` | confirmed | TASK-003 |
...
| Parchment | 2024.11.17 | ❓需确认 | `libs.versions.toml` | https://parchmentmc.org/docs/getting-started | 检查 MC 版本矩阵 | unknown | TASK-001 |
| modDevGradle | 2.0.141 | ❓可能需 ≥2.0.200 | `libs.versions.toml` | https://github.com/neoforged/moddevgradle/releases | 检查 26.1.2 兼容说明 | unknown | TASK-001 |
| LDLib2 | 2.2.8 | ❓需验证 | `forge.versions.toml` | LDLib2 Maven repo / GitHub releases | `.\gradlew.bat dependencies --refresh-dependencies \| grep ldlib2` | unknown | TASK-004 |
| Registrate | MC1.21-1.3.0+67 | ✅ 1.21.1 | `forge.versions.toml` | https://github.com/tterrag1098/Registrate/releases | `.\gradlew.bat dependencies \| grep registrate` | unknown | TASK-001 |
| Configuration | 3.1.1-neoforge | ✅ 1.21.1 | `forge.versions.toml` | https://github.com/toma1O6/Configuration/releases | `.\gradlew.bat dependencies \| grep configuration` | unknown | TASK-001 |
| JEI | 19.25.1.328 | ✅ 1.21.1 | `forge.versions.toml` | https://repo1.maven.org/maven2/mezz/jei/ | `.\gradlew.bat dependencies \| grep jei` | unknown | TASK-005 |
| EMI | 1.1.22+1.21.1 | ✅ 1.21.1 | `forge.versions.toml` | https://maven.terraformersmc.com/ | `.\gradlew.bat dependencies \| grep emi` | unknown | TASK-005 |
| Jade | 15.10.0+neoforge | ✅ | 外部 Maven | Modrinth Maven 元数据 | `.\gradlew.bat dependencies \| grep jade` | unknown | TASK-005 |
| Sodium | 0.6.13-neoforge | ✅ | Modrinth | Modrinth Maven 元数据 | `.\gradlew.bat dependencies \| grep sodium` | unknown | TASK-005 |
| Iris | 1.8.8+1.21.1-neoforge | ✅ | Modrinth | Modrinth Maven 元数据 | `.\gradlew.bat dependencies \| grep iris` | unknown | TASK-005 |
| ModernUI | 3.12.0.2 | ✅ | Modrinth | Modrinth Maven 元数据 | `.\gradlew.bat dependencies \| grep modernui` | unknown | TASK-005 |
| ModernFix | 5.24.3+mc1.21.1 | ✅ | Modrinth | Modrinth Maven 元数据 | `.\gradlew.bat dependencies \| grep modernfix` | unknown | TASK-005 |
| Spark | 最新 | ✅ | Curse Maven | CurseForge Maven 元数据 | `.\gradlew.bat dependencies \| grep spark` | unknown | TASK-005 |
