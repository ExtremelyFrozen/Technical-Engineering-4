 ...
 * <p>
 * Delegates to {@link FluidSlot#getFullTooltipTexts()} then filters out entries whose
 * {@link TranslatableContents#getKey()} matches one of the hidden keys.
 * Name, amount/capacity, and empty label are preserved unchanged.
 */
