...
public class TENCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BLOCK_TAB =
            CREATIVE_TABS.register("block", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MACHINE_TAB =
            CREATIVE_TABS.register("machine", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ITEM_TAB =
            CREATIVE_TABS.register("item", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TOOL_TAB =
            CREATIVE_TABS.register("tool", () -> CreativeModeTab.builder()
