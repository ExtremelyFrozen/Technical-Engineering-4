...
public class TENFluids {
    ...
    public static final DeferredHolder<Fluid, BaseFlowingFluid.Source> LIQUID_ROYAL_JELLY_SOURCE =
            FLUIDS.register("liquid_royal_jelly", () -> new BaseFlowingFluid.Source(getRoyalJellyProps()));
    ...
    static { ZH_NAMES.put("liquid_royal_jelly", "蜂王浆"); ZH_FLUID_KEYS.put("fluid." + TEN.MOD_ID + ".liquid_royal_jelly", "蜂王浆"); }
    ...
    public static final DeferredHolder<Fluid, BaseFlowingFluid.Source> LIQUID_SPICY_JELLY_SOURCE =
            FLUIDS.register("liquid_spicy_jelly", () -> new BaseFlowingFluid.Source(getSpicyJellyProps()));
    ...
    static { ZH_NAMES.put("liquid_spicy_jelly", "香辣蜂王浆"); ZH_FLUID_KEYS.put("fluid." + TEN.MOD_ID + ".liquid_spicy_jelly", "香辣蜂王浆"); }
    ...
    public static final DeferredHolder<Fluid, BaseFlowingFluid.Source> LIQUID_HONEY_SOURCE =
            FLUIDS.register("liquid_honey", () -> new BaseFlowingFluid.Source(getHoneyProps()));
    ...
    static { ZH_NAMES.put("liquid_honey", "蜂蜜"); ZH_FLUID_KEYS.put("fluid." + TEN.MOD_ID + ".liquid_honey", "蜂蜜"); }
    ...
    public static final DeferredHolder<Fluid, BaseFlowingFluid.Source> LIQUID_XP_SOURCE =
            FLUIDS.register("liquid_xp", () -> new BaseFlowingFluid.Source(getXpProps()));
    ...
    static { ZH_NAMES.put("liquid_xp", "液态经验"); ZH_FLUID_KEYS.put("fluid." + TEN.MOD_ID + ".liquid_xp", "液态经验"); }
    ...
    public static final DeferredHolder<Fluid, BaseFlowingFluid.Source> LIQUID_BIZARRERIE_SOURCE =
            FLUIDS.register("liquid_bizarrerie", () -> new BaseFlowingFluid.Source(getBizarrerieProps()));
    ...
    static { ZH_NAMES.put("liquid_bizarrerie", "奇异物质"); ZH_FLUID_KEYS.put("fluid." + TEN.MOD_ID + ".liquid_bizarrerie", "奇异物质"); }
