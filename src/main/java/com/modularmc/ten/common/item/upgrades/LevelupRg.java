...
public class LevelupRg extends UpgradeItem {
    ...
    public boolean effect(IUpgradableMachine machine) {
        ...
        } else if (machine instanceof com.modularmc.ten.common.blockentity.machine.BlockBreakerBlockEntity
                || machine instanceof com.modularmc.ten.common.blockentity.machine.BlockFormerBlockEntity) {
