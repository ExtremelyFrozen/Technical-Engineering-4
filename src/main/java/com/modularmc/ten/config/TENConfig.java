 ...
 * <p>
 * All ranges and defaults verified against {@code origin/1.21} annotations
 * (see {@code plans/.evidence/evidence_26_1_2_feature_parity_01.md}).
 */
public final class TENConfig {

    // ── COMMON spec (te4-config.toml) ──────────────────────────────────
    ...
    /**
     * {@code machine} block — machine enable toggles and energy multiplier.
    ...
    public static final class MachineConfig {
        ...
        MachineConfig(ModConfigSpec.Builder builder) {
            ...
            energyMultiplier = builder
                    .comment("Global energy multiplier for all machines")
                    .defineInRange("energyMultiplier", 1.0, 0.01, 100.0);

            baseEnergyCapacity = builder
                    .comment("Base energy capacity for machines")
                    .defineInRange("baseEnergyCapacity", 10000, 1000, 1_000_000_000);

            enableSmelter = builder
                    .comment("Enable the Smelter machine")
                    .define("enableSmelter", true);

            enablePulverizer = builder
                    .comment("Enable the Pulverizer machine")
                    .define("enablePulverizer", true);

            enableCompressor = builder
                    .comment("Enable the Compressor machine")
                    .define("enableCompressor", true);

            enableRefiner = builder
                    .comment("Enable the Refiner machine")
                    .define("enableRefiner", true);

            enableInductionFurnace = builder
                    .comment("Enable the Induction Furnace machine")
                    .define("enableInductionFurnace", true);

            enablePsionicant = builder
                    .comment("Enable the Psionicant machine")
                    .define("enablePsionicant", true);

            enableBeacon = builder
                    .comment("Enable the Beacon machine")
                    .define("enableBeacon", true);

            enableMobRipper = builder
                    .comment("Enable the Mob Ripper machine")
                    .define("enableMobRipper", true);

            enableQuarry = builder
                    .comment("Enable the Quarry machine")
                    .define("enableQuarry", true);

            enableEnchantmentFlusher = builder
                    .comment("Enable the Enchantment Flusher machine")
                    .define("enableEnchantmentFlusher", true);

            enableCondenser = builder
                    .comment("Enable the Condenser machine")
                    .define("enableCondenser", true);

            enableFarmManager = builder
                    .comment("Enable the Farm Manager machine")
                    .define("enableFarmManager", true);
    ...
    /**
     * {@code energyUnit} block — Energy Unit item power stats.
    ...
    public static final class EnergyUnitConfig {
        ...
        EnergyUnitConfig(ModConfigSpec.Builder builder) {
            builder.push("energyUnit")
                    .comment("Energy Unit item configuration");

            maxEnergy = builder
                    .comment("Maximum energy storage of the Energy Unit")
                    .defineInRange("maxEnergy", 400_000, 1000, 100_000_000);

            chargeRate = builder
                    .comment("Energy Unit charge rate (FE/t)")
                    .defineInRange("chargeRate", 2_000, 1, 100_000);

            inputRate = builder
                    .comment("Energy Unit input rate (FE/t)")
                    .defineInRange("inputRate", 2_000, 1, 100_000);

            outputRate = builder
                    .comment("Energy Unit output rate (FE/t)")
                    .defineInRange("outputRate", 2_000, 1, 100_000);

            chargingDefault = builder
                    .comment("Default charging mode for new Energy Units")
                    .define("chargingDefault", false);
    ...
    /**
     * {@code farm} block — Farm Manager crop configuration.
    ...
    public static final class FarmConfig {
        ...
        FarmConfig(ModConfigSpec.Builder builder) {
            builder.push("farm")
                    .comment("Farm Manager crop configuration");

            bushCrops = builder
                    .comment("List of bush crop block IDs that the Farm Manager can harvest")
                    .defineList("bushCrops",
    ...
    /**
     * {@code client} block — Client-side HUD toggles.
    ...
    public static final class ClientConfig {
        ...
        ClientConfig(ModConfigSpec.Builder builder) {
            builder.push("client")
                    .comment("Client-side HUD configuration");

            showMachineHUD = builder
                    .comment("Show machine HUD overlay")
                    .define("showMachineHUD", true);

            showCableHUD = builder
                    .comment("Show cable HUD overlay")
