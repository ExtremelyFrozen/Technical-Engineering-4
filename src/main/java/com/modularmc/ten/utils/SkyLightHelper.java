 ...
 * <li>昼间 — {@link Level#getDayTime()} % 24000 &lt; 12000</li>
 * </ol>
 */
public final class SkyLightHelper {
    ...
    public static boolean hasEffectiveLight(Level level, BlockPos pos) {
        ...
        // MC 1.21.1: getDayTime() 返回当前维度时钟（主世界 = 世界总 tick）
        // 26.1.2 分支用 getOverworldClockTime()（固定 overworld 时钟），此处用 getDayTime() 对齐昼间语义。
